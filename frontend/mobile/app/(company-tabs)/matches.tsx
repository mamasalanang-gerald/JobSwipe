...
// ─── Data (company perspective — applicants, not job listings) ────────────────
const NEW_MATCHES: {
  id: string; name: string; role: string;
  avatar: string; isNew: boolean;
}[] = [
  {
    id: '1', name: 'Maria Santos', role: 'Frontend Dev',
    avatar: 'https://randomuser.me/api/portraits/women/44.jpg', isNew: true,
  },
  {
    id: '2', name: 'Pedro Lim', role: 'Full Stack',
    avatar: 'https://randomuser.me/api/portraits/men/55.jpg', isNew: true,
  },
  {
    id: '3', name: 'Aisha Khan', role: 'ML Engineer',
    avatar: 'https://randomuser.me/api/portraits/women/65.jpg', isNew: true,
  },
];
...
const PIPELINE: {
  ...
  },
  {
    ...
    time: '3h', unread: 0, status: 'new', expired: true,
  },
  {
...
function GhostCard({
  rotate, translateX, translateY, blur,
}: {
  ...
  return (
    <View style={s.emptyWrap}>
      ...
      <Text style={s.emptySub}>
        Swipe on candidate profiles to match with top applicants for your open roles.
      </Text>
        ...
        {activeTab === 'reviews' && (
          <>
            {selectedApplicant ? (
                  ...
                  {reviewSubmitted ? (
                    ...
                    <>
                      ...
                      <TouchableOpacity
                        style={[
                          s.submitBtn,
                          (!reviewRating || !reviewTitle.trim() || !reviewBody.trim()) && s.submitBtnDisabled,
                        ]}
              ...
              // Closed applicants list
              (() => {
                return CLOSED_APPLICANTS.length === 0 ? (
...
const s = StyleSheet.create({
  ...
  segTab: {
    ...
    justifyContent: 'center', paddingVertical: 9, borderRadius: 10, gap: 6,
  },
  ...
  divider: {
    ...
    backgroundColor: T.borderFaint, marginVertical: 8,
  },

  // ── Empty state ───────────────────────────────────────────────────────────
  emptyWrap:  { alignItems: 'center', paddingTop: 24, paddingHorizontal: 32 },
  ghostStack: {
    width: SCREEN_WIDTH - 64, height: 210,
    position: 'relative', alignItems: 'center',
    justifyContent: 'center', marginBottom: 28,
  },
  ghostCard: {
    position: 'absolute', width: 136, height: 182, borderRadius: 20,
    backgroundColor: T.surface, borderWidth: 1, borderColor: T.border,
    shadowColor: '#000', shadowOffset: { width: 0, height: 8 },
    shadowOpacity: 0.3, shadowRadius: 20, elevation: 6, overflow: 'hidden',
  },
  ...
  boltBadge: {
    position: 'absolute', top: 14, left: '28%' as any,
  ...
  emptyTitle: {
    fontSize: 21, fontWeight: '800', color: T.textPrimary,
  ...
  boostBtn: {
    ...
    backgroundColor: T.primary, borderRadius: 50,
  ...
  unreadBadge: {
    ...
    backgroundColor: T.primary, borderWidth: 2, borderColor: T.surface,
    alignItems: 'center', justifyContent: 'center',
  },
  ...
  closedTag: {
    ...
    backgroundColor: T.borderFaint, borderRadius: 20,
  ...
  leaveReviewBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 4,
    backgroundColor: 'rgba(168,85,247,0.12)', borderRadius: 20,
  ...
  successCard: {
    ...
    borderRadius: 16, borderWidth: 1, borderColor: 'rgba(34,197,94,0.2)',
  ...
  textField: {
    ...
    fontSize: 14, color: T.textPrimary, marginBottom: 10,
  },

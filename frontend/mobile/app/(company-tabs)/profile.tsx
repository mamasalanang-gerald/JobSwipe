  ...
  const renderPlan = ({ item }: { item: Plan }) => {
    ...
    return (
      <View style={[ps.card, { width: PLAN_W, borderColor: item.border, backgroundColor: item.bg }]}>
        ...
        {item.cta && !isCurrent ? (
          <TouchableOpacity style={[ps.cta, { backgroundColor: item.color }]} activeOpacity={0.85} onPress={() => router.push('/subscription')}>
...
const s = StyleSheet.create({
  ...
  // Cover
  coverWrap:    { width: '100%', height: 130, backgroundColor: T.surfaceHigh, position: 'relative', overflow: 'hidden' },
  coverImg:     { width: '100%', height: '100%' },
  coverFallback:{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#16102a', gap: 6 },
  coverHint:    { fontSize: 11, color: 'rgba(168,85,247,0.45)' },
  coverScrim:   { position: 'absolute', bottom: 0, left: 0, right: 0, height: 40, backgroundColor: 'rgba(15,10,30,0.6)' },

  // Hero row
  heroRow:      { flexDirection: 'row', alignItems: 'flex-end', paddingHorizontal: 20, paddingBottom: 20, marginTop: -38 },
  logoWrap:     { position: 'relative' },
  logoImg:      { width: 76, height: 76, borderRadius: 20, borderWidth: 3, borderColor: T.bg },
  logoFallback: { width: 76, height: 76, borderRadius: 20, backgroundColor: '#2d1b69', alignItems: 'center', justifyContent: 'center', borderWidth: 3, borderColor: T.bg },
  logoInitials: { fontSize: 22, fontWeight: '800', color: '#fff' },
  camBadge:     { position: 'absolute', bottom: 1, right: 1, width: 22, height: 22, borderRadius: 11, backgroundColor: T.primary, borderWidth: 2, borderColor: T.bg, alignItems: 'center', justifyContent: 'center' },
  ...
  editBtn:      { flexDirection: 'row', alignItems: 'center', gap: 4, borderWidth: 1, borderColor: 'rgba(168,85,247,0.28)', borderRadius: 20, paddingHorizontal: 11, paddingVertical: 5, backgroundColor: 'rgba(168,85,247,0.08)', alignSelf: 'flex-end', marginBottom: 4 },
  ...
  // Stats
  statsCard:    { flexDirection: 'row', marginHorizontal: 24, backgroundColor: T.surface, borderRadius: 16, borderWidth: 1, borderColor: T.border, paddingVertical: 16 },
  ...
  photoSlot:    { flex: 1, aspectRatio: 0.85, borderRadius: 14, backgroundColor: T.surfaceHigh, borderWidth: 1, borderColor: T.border, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  ...
  // Sign out
  signOut:     { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7, marginHorizontal: 24, marginTop: 28, paddingVertical: 13, borderRadius: 13, backgroundColor: T.dangerBg, borderWidth: 1, borderColor: 'rgba(239,68,68,0.15)' },
  signOutText: { fontSize: 13, fontWeight: '700', color: T.danger },

  // Add forms
  addForm:        { marginTop: 16, padding: 14, borderRadius: 14, backgroundColor: T.surfaceHigh, borderWidth: 1, borderColor: T.border, gap: 10 },
  addInput:       { backgroundColor: T.surface, borderRadius: 10, borderWidth: 1, borderColor: T.border, paddingHorizontal: 12, paddingVertical: 10, fontSize: 13, color: T.textPrimary },
